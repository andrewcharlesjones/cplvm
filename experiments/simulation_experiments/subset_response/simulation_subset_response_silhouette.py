...
if __name__ == "__main__":
    ...
    for _ in range(N_REPEATS):
        ...
        pca_reduced_data = PCA(n_components=latent_dim_target).fit_transform(
            data_for_pca
        )

        sil_score_pca = silhouette_score(
            X=pca_reduced_data[num_datapoints_x:, :], labels=labs
        )
        ...
        sil_score_nmf = silhouette_score(
            X=reduced_data[num_datapoints_x:, :], labels=labs
        )
