...
plt.subplot(121)
g = sns.lineplot(data=times_df_melted_numgenes, x="variable", y="value", ci=95, err_style="bars", color="black", style="model")
...
plt.subplot(122)
g = sns.lineplot(data=times_df_melted_numsamples, x="variable", y="value", ci=95, err_style="bars", color="black", style="model")
g.legend_.set_title(None)
