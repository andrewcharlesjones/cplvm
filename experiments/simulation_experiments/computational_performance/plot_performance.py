...
times_df_melted_numgenes = pd.read_csv(
    "../out/time_performance_num_genes.csv", index_col=0
)
...
times_df_melted_numsamples = pd.read_csv(
    "../out/time_performance_num_samples.csv", index_col=0
)
...
plt.subplot(122)
g = sns.lineplot(
    data=times_df_melted_numsamples,
    x="variable",
    y="value",
    ci=95,
    err_style="bars",
